...
export const ListLetterIndex: React.FC<ListLetterIndexProps> = ({ sectionData, onPressLetter, indexLetterColor }) => {
				...
				renderItem={({ item, index }) => (
					<TouchableOpacity testID="indexItem" onPress={() => onPressLetter(index)}>
						<View style={styles.letterIndexItem}>
							<Text testID="indexItem__title" style={[styles.letterIndexLabel, labelStyle]}>
								{item.title}
							</Text>
						</View>
					</TouchableOpacity>
